...
execute as @e[type=minecraft:interaction,nbt={interaction:{}},tag=biomewand] at @s run execute as Craemon at @s anchored eyes positioned ^ ^ ^ anchored feet run function biomechanger:start_ray_pos2
